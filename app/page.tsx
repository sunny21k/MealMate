...
import { BiCheck, BiChevronsUp } from "react-icons/bi";

export default function Home() {
	return (
		<div className="px-4 py-8 sm:py-12 lg:py-16 max-w-7xl mx-auto">
			<section className="bg-gradient-to-r from bg-emerald-400 to-emerald-600 text-white rounded-lg mb-12 p-8 text-center">
				...
				<Link
					href="/sign-up"
					className="inline-block bg-white text-emerald-500 font-medium px-5 py-3
			...
			<section id="how-it-works" className="mb-12">
				...
				<div className="flex flex-col md:flex-row justify-center items-centerx space-y-8 md:space-y-0 md:space-x-8">
